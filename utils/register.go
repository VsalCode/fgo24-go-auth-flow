...
// func (x DataRegister) md5Encode() string {
// 	hash := md5.New()
// 	_, _ = hash.Write([]byte(x.password))

// 	md5 := hash.Sum(nil)
// 	result := fmt.Sprintf("%s",md5)
// 	return result
// }

// func getConvert(u User) DataUser {
// 	return DataUser{
// 		fullname: u.getFullName(),
// 		password: u.md5Encode(),
// 	}
// }
...
// 	updateData := getConvert(userRegist)
